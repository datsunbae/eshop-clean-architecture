...
//                    throw new DomainException("SpecificationBuilderExtensions.AdvancedFilter.FiltersAttributeIsRequired", "The Filters attribute is required when declaring a logic");
...
//            {
//                if (filter.Filters is null) 
//                    throw new DomainException("SpecificationBuilderExtensions.CreateFilterExpression.FiltersAttributeIsRequired", "The Filters attribute is required when declaring a logic");
...
//            _ => throw new DomainException("SpecificationBuilderExtensions.CreateFilterExpression.FilterNotValid", "Filter Operator is not valid."),
//        };
//    }
...
//                throw new DomainException("SpecificationBuilderExtensions.GeValuetExpression.NotValid", string.Format("Value {0} is not valid for {1}", value, field));
...
//            throw new DomainException("SpecificationBuilderExtensions.GetValidFilter.FieldAtrributeIsRequired", "The field attribute is required when declaring a filter");

//        if (string.IsNullOrEmpty(filter.Operator)) 
//            throw new DomainException("SpecificationBuilderExtensions.GetValidFilter.OperatorAtrribureIsRequired", "The Operator attribute is required when declaring a filter");
