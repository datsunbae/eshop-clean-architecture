...
using CleanArchitecture.Application.Common.Notifications;
...
public class SendEventNotificationToClientsHandler<TNotification> : IDomainEventHandler<TNotification>
